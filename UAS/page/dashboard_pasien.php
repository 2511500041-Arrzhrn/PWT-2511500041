        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="small-box bg-info shadow dashboard-card">
                    ...
                    <a href="index.php?page=konsultasi_pasien" class="small-box-footer">
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="small-box bg-success shadow dashboard-card">
                    ...
                    <a href="index.php?page=perawatan_pasien" class="small-box-footer">
                        Lihat Detail <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="small-box bg-warning shadow dashboard-card">
                    ...
                    <a href="index.php?page=medical_checkup_pasien" class="small-box-footer">
                        Lihat Detail <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
